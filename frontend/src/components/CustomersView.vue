...
export default {
    ...
    methods: {
        ...mapActions(useCounterStore, ["fetchCustomers", "addCustomer", "deleteFetchCustomer"]),
...
<template>
    <div class="w3-container w3-margin-top">
        ...
        <router-link class="w3-button w3-green w3-round-large w3-right" to="/customers">Customers</router-link>
        <router-link class="w3-button w3-green w3-round-large w3-right" to="/waiters">Waiters</router-link>
        <router-link class="w3-button w3-green w3-round-large w3-right" to="/tables">Tables</router-link>
        <router-link class="w3-button w3-green w3-round-large w3-right" to="/items">Items</router-link>
    </div>
