...
const ReservationService = require('../../services/restaurant-dashboard/reservation-service');
...
router.get('/sort/status/:order', async (req, res) => {
    ...
    try {
        const sortedReservations = await ReservationService.sortReservationsByStatus(order);
